export const toString = Function.call.bind<Function>(Object.prototype.toString);
...
export const generateLoadManagerKey = (moduleName: string, blockKey: string) =>
  `${moduleName}_${blockKey}`;
