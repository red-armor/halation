...
var Module = /*#__PURE__*/function () {
  function Module(props) {
    ...
    this.statusMap = new Map([[ModuleName.Model, ModuleStatus.Idle], [ModuleName.Component, ModuleStatus.Idle]]);
    this.resolversMap = new Map([[ModuleName.Model, []], [ModuleName.Component, []]]);
    this.resolvedModulesMap = new Map([[ModuleName.Model, null], [ModuleName.Component, null]]);
    ...
    return new Promise(function (resolve) {
      ...
      switch (currentStatus) {
        case ModuleStatus.Idle:
          ...
          _this.statusMap.set(moduleName, ModuleStatus.Pending);
      ...
      if (fn) {
        ...
        Promise.resolve(fn.call(_this)).then(function (rawModule) {
          ...
          _this.statusMap.set(moduleName, ModuleStatus.Loaded);
        }, function () {
          error({
            type: 'module',
...
var BlockWrapper = function BlockWrapper(props) {
  ...
  var unsubscribeLoadRoutine = useRef(null);
  var loadRoutine = useCallback(function () {
  ...
  var forceUpdate = useCallback(function (result) {
  ...
  var loadAndForceUpdate = useCallback(function () {
  ...
  if (blockRenderer) {
    return React.createElement(Fragment, null, createElement(blockRenderer, props, React.createElement(RefForwardingWrapper, Object.assign({}, props, {
      ref: blockRef
    }))), React.createElement(Helper, null));
  }

  return React.createElement(Fragment, null, React.createElement(RefForwardingWrapper, Object.assign({}, props, {
    ref: blockRef
  })), React.createElement(Helper, null));
};
...
var BlockNode = function BlockNode(props) {
  ...
  childKeys.forEach(function (childKey) {
    ...
    if (node) {
      children.push(createElement(BlockNode, _extends({
        key: childKey,
        block: node,
        nodeMap: nodeMap,
...
var Halation = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    if (typeof this.rootRenderFn === 'function') {
      return React.createElement(this.rootRenderFn, _extends({}, this.getPropsAPI()), children);
    }
...
export { Halation, ModuleName, ModuleStatus, Node, StrategyType };
//# sourceMappingURL=halation.esm.js.map
